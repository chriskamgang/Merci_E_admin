    ...
    { 
        ...
        DB::table('landing_headers')->insert([
            [
                ...
                'footer_para' => 'Merci E est une plateforme de transport facilitating peer to peer ridesharing by means of connecting passengers who are in need of rides from drivers with available cars to get from point A to point B with the press of a button.',
                ...
                'user_play_link' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'user_apple' => 'Apple Store',
                'user_apple_link' => 'https://apps.apple.com/app/mercie-user
                'driver_app' => 'Driver Apps',
                'driver_play' => 'Play Store',
                'driver_play_link' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
                'driver_apple' => 'Apple Store',
                'driver_apple_link' => 'https://apps.apple.com/app/mercie-driver
                'copy_rights' => '2026 Merci E. Tous droits reserves.
             ...
             [
                ...
                'footer_logo' => 'rest.png',
                'footer_para' => 'Merci E est une plateforme de transport تسهل مشاركة الركوب من نظير إلى نظير من خلال ربط الركاب الذين يحتاجون إلى ركوب بسيارات السائقين المتوفرة للانتقال من النقطة أ إلى النقطة ب بضغطة زر.',
            ...
            [
                ...
                'footer_logo' => 'rest.png',
                'footer_para' => 'Merci E est une plateforme de transport facilitant le partage de trajets entre pairs en connectant les passagers ayant besoin de trajets avec des conducteurs disposant de voitures disponibles pour aller d\'un point A à un point B en appuyant sur un bouton.',
            ...
            [
                ...
                'footer_logo' => 'rest.png',
                'footer_para' => 'Merci E est une plateforme de viajes compartidos que conecta pasajeros con conductores disponibles para ir de un punto A a un punto B con solo presionar un botón.',
        ...
        DB::table('landing_homes')->insert([
            ...
            [
                'id' => Str::uuid(),
                'hero_title' => 'It’s time to change your ride experience! Download the Merci E Today!',
                'hero_user_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'hero_user_link_apple' => 'https://apps.apple.com/app/mercie-user
                'hero_driver_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
                'hero_driver_link_apple' => 'https://apps.apple.com/app/mercie-driver
                'feature_heading' => 'Advantage of using our Apps',
                'feature_para' => 'Merci E can provide a superior transportation experience for passengers and drivers alike, fostering a more efficient and user-friendly ecosystem',
                ...
                'service_para' => 'Merci E takes pride, delivering on-demand dispatch solution.',
                ...
                'drive_para_1' => 'Merci E est une plateforme de transport facilitating peer-to-peer ridesharing by means of connecting passengers who are in need of rides from drivers with available cars to get from point A to point B with the press of a button.',
            ...
            [
                'id' => Str::uuid(),
                'hero_title' => 'حان الوقت لتغيير تجربة رحلتك! قم بتنزيل Merci E اليوم!',
                'hero_user_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'hero_user_link_apple' => 'https://apps.apple.com/app/mercie-user
                'hero_driver_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
                'hero_driver_link_apple' => 'https://apps.apple.com/app/mercie-driver
                'feature_heading' => 'مزايا استخدام تطبيقاتنا',
                'feature_para' => 'يوفر Merci E تجربة نقل متميزة للركاب والسائقين على حد سواء، مما يخلق بيئة أكثر كفاءة وسهولة في الاستخدام.',
            ...
            [
                'id' => Str::uuid(),
                'hero_title' => 'Il est temps de changer votre expérience de trajet ! Téléchargez l\'application Merci E aujourd\'hui !',
                'hero_user_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'hero_user_link_apple' => 'https://apps.apple.com/app/mercie-user
                'hero_driver_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
                'hero_driver_link_apple' => 'https://apps.apple.com/app/mercie-driver
                'feature_heading' => 'Avantages de nos applications',
                'feature_para' => 'L\'application Merci E offre une expérience de transport supérieure pour les passagers et les conducteurs, favorisant un écosystème plus efficace et convivial.',
                ...
                'service_para' => 'Merci E se targue de fournir une solution de répartition à la demande.',
            ...
            [
                'id' => Str::uuid(),
                'hero_title' => '¡Es hora de cambiar tu experiencia de viaje! ¡Descarga Merci E hoy!',
                'hero_user_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'hero_user_link_apple' => 'https://apps.apple.com/app/mercie-user
                'hero_driver_link_android' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
                'hero_driver_link_apple' => 'https://apps.apple.com/app/mercie-driver
                'feature_heading' => 'Beneficios de nuestras aplicaciones',
                'feature_para' => 'La aplicación Merci E ofrece una experiencia de transporte superior para pasajeros y conductores, creando un ecosistema más eficiente y fácil de usar.',
    ...
    $user = LandingUser::first();
        ...
        DB::table('landing_users')->insert([
         [
            ...
            'how_it_work_para_2' => 'You can complete the Signup process in Merci E User App',
        ...
        'how_it_work_para_2' => 'يمكنك إتمام عملية التسجيل في تطبيق Merci E',
        'how_it_work_img_2' => 'u2.png',
        ...
        'how_it_work_para_2' => 'Vous pouvez compléter l\'inscription dans l\'application Merci E',
        'how_it_work_img_2' => 'u2.png',
        ...
        'how_it_work_para_2' => 'Puedes completar el proceso de registro en la aplicación Merci E',
        'how_it_work_img_2' => 'u2.png',
    ...
    $contact = LandingContact::first();
        ...
        DB::table('landing_contacts')->insert([
           [
            ...
            'contact_phone' => '+237 659 339 778',
            'contact_mail_title' => 'MAIL',
            'contact_mail' => 'merciestuaire@gmail.com',
            'contact_web_title' => 'WEBSITE',
            'contact_web' => 'https://merciestuaire.com/',
            'form_name' => 'Name',
            'form_mail' => 'Email',
    ...
    $quick = LandingQuickLink::first();
        ...
        [
            ...
            'terms' => '<h2><strong>الشروط والأحكام</strong></h2>
                ...
                <br />
                4.2 Merci E والمستخدم النهائي يعترفان بأن Apple و OR Play ليس عليهم التزام على الإطلاق بتقديم أي خدمات صيانة ودعم فيما يتعلق بالتطبيق المرخص. </p>
                ...
                <br />
                9.4 إذا أكدنا أن التطبيق معيب ، تحتفظ Merci E باختيار لعلاج الموقف إما عن طريق حل العيب أو التسليم البديل. <BR />
                <br />
                ...
                Clemmons ، NC 27012 <BR />
                الولايات المتحدة <br />
                دعم@Merci E.us </strong> </p>

                <p> 13. إنهاء </p>

                <p> يكون الترخيص صالحًا حتى يتم إنهاءه بواسطة Mi Softwares ، LLC أو من قبلك. ستنتهي حقوقك بموجب هذا الترخيص تلقائيًا ودون إشعار من Merci E إذا فشلت في الالتزام بأي مصطلح (ق) من هذا الترخيص. عند إنهاء الترخيص ، يجب عليك إيقاف كل استخدام التطبيق ، وتدمير جميع النسخ ، كاملة أو جزئية ، للتطبيق. </p>

                <p> 14. شروط الاتفاقيات والمستفيد من الطرف الثالث </p>

                <p> Merci E تمثل وتستدعي أن Merci E ستقوم بالامتثال لشروط الاتفاقية المعمول بها عند استخدام التطبيق المرخص. <BR />
                <br />
         ...
         [
            ...
            'terms' => '<h2><strong>Conditions générales</strong></h2>
                ...
                <br />
                4.2 Merci E, LLC et lutilisateur final reconnaissent quApple et / Google Play nont aucune obligation de fournir des services de maintenance et de soutien en ce qui concerne lapplication sous licence. </p>
                ...
                <br />
                9.4 Si nous confirmons que lapplication est défectueuse, Merci E, LLC se réserve un choix pour remédier à la situation en résolvant le défaut ou la livraison de remplacement. <Br />
                <br />
                ...
                <p> Merci E, LLC représente et justifie que Mi Softwares, LLC se conformera aux conditions de laccord tierces applicables lors de lutilisation de lapplication sous licence. <Br />
                <br />
                ...
                <P> Merci E, LLC et lutilisateur final reconnaissent que, en cas de réclamation de tiers que la demande agréée ou la possession et lutilisation de cette demande de licence infligées aux droits de propriété intellectuelle du tiers, MI, Merci E, LLC, et non Apple, sera seul responsable de lenquête, de la défense, du règlement et de la libération ou de toutes ces réclamations dinfraction de propriété intellectuelle. </p>
            ...
            'compliance' => '<h3> <strong> Opportunité demploi égal et politique de non-discrimination </strong> </h3>
                ...
                <p> représailles contre toute personne associée à Mi Softwares, LLC qui rapporte des cas de harcèlement - quil soit directement ou indirectement impliquée - est en violation des politiques de Merci E, LLC. Tous les incidents signalés sont supposés être faits de bonne foi. Toutes les allégations qui sont prouvées fausses seront traitées comme une affaire sérieuse. </p>
                ...
                Le PDG de Merci E, Lynn Graham, soutient pleinement la mise en œuvre de cette politique à compter du 19 avril 2021. </p>' ,
            'dmv_title' => 'dmv check',
         ...
         [
            ...
            'terms' => '<h2><strong>Términos y condiciones</strong></h2>
                ...
                <br />
                4.2 Merci E, LLC y el usuario final reconocen que Apple y Google Play no tienen ninguna obligación de proporcionar ningún servicio de mantenimiento y soporte con respecto a la aplicación con licencia. </p>
                ...
                <p> La licencia es válida hasta que Merci E, LLC o por usted. Sus derechos bajo esta licencia terminarán automáticamente y sin previo aviso de Merci E, LLC, si no se adhiere a ningún término de esta licencia. Tras la terminación de la licencia, detendrá todo el uso de la solicitud y destruirá todas las copias, completas o parciales de la aplicación. </p>

                <p> 14. Términos de acuerdos y beneficiarios de terceros </p>

                <p> mi softwares, LLC representa y garantiza que Merci E, LLC cumplirá con los términos de acuerdo de terceros aplicables cuando se use la aplicación con licencia. <Br />
                <br />
                ...
                <p> Merci E, LLC y el usuario final reconocen que, en el caso de cualquier reclamo de terceros, la solicitud con licencia o la posesión del usuario final y el uso de esa solicitud con licencia infringen los derechos de propiedad intelectual del tercero, Merci E, LLC, y no Apple, será el único responsable de la investigación, defensa, liquidación y alta o cualquier reclamación de infracción de propiedad intelectual. </p>
            ...
            'dmv' => '<h2> <strong> dmv verificación y consentimiento de verificación de antecedentes </strong> </h2>
                ...
                <P> Entiendo que mi softwares, LLC. ("Compañía") utilizará Checkr. ("Checkr, Inc.") para obtener un registro de vehículos de motor como parte del proceso de solicitud para ser un conductor en la plataforma SoftWares MI (un "conductor"). También entiendo que si se acepta como conductor, en la medida permitida por la ley, la compañía puede obtener más informes de Checkr Inc. para actualizar, renovar o extender mi estado como conductor. Por la presente, doy permiso a Merci E para obtener mi registro de conducción estatal (también conocido como mi registro de vehículos motorizados o MVR) de acuerdo con la Ley de Protección de Privacidad Federal del Conductor ("DPPA") y la ley estatal aplicable. Reconozco y entiendo que mi registro de conducción es un informe del consumidor que contiene información de registros públicos. Autorizo, sin reserva, cualquier parte o agencia contactada por Company o Checkr Inc. para proporcionar a la compañía una copia de mi historial de manejo del estado. Esta autorización permanecerá en el archivo de la compañía durante la duración de mi tiempo como conductor, y servirá como autorización continua para que la compañía obtenga mi registro de conducción de estado en cualquier momento mientras yo soy un conductor. </p>
