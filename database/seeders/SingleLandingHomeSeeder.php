    ...
    { 
        ...
        DB::table('single_landing_page')->insert([
            ...
            [
                ...
                'app_works_para' => ' Get started in just a few simple steps. Choose your ride, track your driver, and enjoy a smooth, hassle-free journey with Merci E. ',
                ...
                'why_choose_title' => ' Why Choose Merci E ? ',
                ...
                'download_user_link_android' => 'https://apps.apple.com/app/mercie-user
                'download_user_link_apple' => 'https://play.google.com/store/apps/details?id=com.mercie.user',
                'download_driver_link_android' => 'https://apps.apple.com/app/mercie-driver
                'download_driver_link_apple' => 'https://play.google.com/store/apps/details?id=com.mercie.driver',
    ...
    $quick = LandingQuickLink::first();
        ...
        [
            ...
            'terms' => '<h2><strong>الشروط والأحكام</strong></h2>
                ...
                <br />
                4.2 Merci E ، LLC والمستخدم النهائي يعترفان بأن Apple و OR Play ليس عليهم التزام على الإطلاق بتقديم أي خدمات صيانة ودعم فيما يتعلق بالتطبيق المرخص. </p>
                ...
                <br />
                9.4 إذا أكدنا أن التطبيق معيب ، تحتفظ Merci E ، LLC باختيار لعلاج الموقف إما عن طريق حل العيب أو التسليم البديل. <BR />
                <br />
                ...
                <p> يكون الترخيص صالحًا حتى يتم إنهاءه بواسطة Mi Softwares ، LLC أو من قبلك. ستنتهي حقوقك بموجب هذا الترخيص تلقائيًا ودون إشعار من Merci E ، LLC إذا فشلت في الالتزام بأي مصطلح (ق) من هذا الترخيص. عند إنهاء الترخيص ، يجب عليك إيقاف كل استخدام التطبيق ، وتدمير جميع النسخ ، كاملة أو جزئية ، للتطبيق. </p>

                <p> 14. شروط الاتفاقيات والمستفيد من الطرف الثالث </p>

                <p> Merci E ، LLC تمثل وتستدعي أن Merci E ، LLC ستقوم بالامتثال لشروط الاتفاقية المعمول بها عند استخدام التطبيق المرخص. <BR />
                <br />
