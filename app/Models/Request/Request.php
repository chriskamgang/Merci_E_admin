...
{
    use HasActiveCompanyKey,SearchableTrait,UuidModel;
    ...
    /**
     * Restrict the query to requests the given (or authenticated) API user is a party to:
     * - user role: requests where they are the passenger
     * - driver role: requests assigned to their driver record
     * - owner role: requests belonging to their fleet (requests.owner_id)
     * Any other role matches nothing.
     */
    public function scopeVisibleTo($query, $user = null)
    {
        ...
        return $query->where(function ($q) use ($user) {
            ...
            if ($user->hasRole(Role::OWNER) && $user->owner) {
