                                        ...
                                        <div class="row  row-cols-lg-3 row-cols-1">
                                            <div class="col">
                                                <div class="card card-body border card-hover">
                                                    ...
                                                    <div class="d-flex">
                                                        <!-- <i class="bx bx-rupee" style="font-size: 25px;"></i> -->
                                                        <h3 class="mb-1">{{owner_wallet.amount_added ?? 0}} {{ currencySymbol }}</h3>
                                                    </div>                                                                
                                            ...
                                            <div class="col">
                                                <div class="card card-body border card-hover">
                                                    ...
                                                    <div class="d-flex">
                                                        <h3 class="mb-1">{{owner_wallet.amount_spent ?? 0}} {{ currencySymbol }}</h3>
                                                    </div>
                                            ...
                                            <div class="col">
                                                <div class="card card-body border card-hover">
                                                    ...
                                                    <div class="d-flex">
                                                        <h3 class="mb-1">{{owner_wallet.amount_balance ?? 0}} {{ currencySymbol }}</h3>
                                                    </div>
                                            ...
                                            <table class="table align-middle position-relative table-nowrap">
                                                ...
                                                <tbody v-if="results1.length > 0">
                                                    <tr v-for="(result, index) in results1" :key="index">
                                                        ...
                                                        <td>{{ result.amount ?? '-' }} {{ currencySymbol }}</td>
