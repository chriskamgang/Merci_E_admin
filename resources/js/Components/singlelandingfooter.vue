...
<template>
            <footer class="custom-footer py-3 position-relative"    style="background-color: var(--single_landing_footer_bg_color); color: var(--single_landing_footer_text);">
            <BContainer>
                <BRow>
                    <BCol lg="4" class="mt-4">
                        <div>
                            <div>
                                <img  :src="footerLogoUrl" alt="logo light" style="height: 45px; width: auto;">
                            </div>
                ...
                <BRow class="text-center text-sm-start align-items-center mt-5">
                    <BCol sm="6">
                        ...
                        <div>
                            <p class="copy-rights mb-0 currentyear" style="color:var(--landing_footer_text);">{{ headers.copy_rights }} · Dev by <strong>Chris Skyler</strong></p>
                        </div>
                    </BCol>
                    <BCol sm="6">
