...
<template>
    <nav class="navbar navbar-expand-lg navbar-landing fixed-top" style="background-color: var(--landing_header_bg); padding-top: 8px; padding-bottom: 8px;" id="navbar">
        <BContainer>
            <Link class="navbar-brand">
                <img :src="headerLogoUrl()" class="card-logo card-logo-dark" alt="logo light" style="height: 45px; width: auto;">
            </Link>
            ...
            <BCollapse class="navbar-collapse" id="navbarSupportedContent" v-model="isCollapsed">
                ...
                <div class="d-flex gap-2">
                    ...
                    <BLink class="btn text-white" href="/mi-admin" style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3);"><i class="ri-dashboard-line me-1"></i>Dashboard</BLink>
                </div>
            </BCollapse>
        </BContainer>
    </nav>
