                                            ...
                                            <tr>
                                                <td>
                                                    <div style="display: flex;margin-top: 2rem;" class="mt-5">
                                                      <a href="{{ $notificationData['button_url'] }}" target="_blank" class="btn btn-primary ms-auto me-auto" style="background-color:#0355A7;color:white;padding:5px;">{{ $notificationData['button_name'] }}</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody></table>
